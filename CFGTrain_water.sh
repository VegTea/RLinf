...
export YAM_WATER_PI05_TORCH_CKPT=/inspire/ssd/project/gjjproject/czxs24230043/RLinf/checkpoints/torch/yam_pi05_seal_water_bottle_cap_120000

bash examples/recap/cfg/run_cfg_sft.sh yam_seal-water-bottle-cap_cfg_openpi \
  data.num_workers=12 \
