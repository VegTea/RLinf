...
**Example: pi0 model**
```bash 
python toolkits/standalone_eval_scripts/openpi/libero_eval.py \
...
**Example: pi0 model**
```bash
python toolkits/standalone_eval_scripts/openpi/metaworld_eval.py \
...
**Example: pi0 model**
```bash
python toolkits/standalone_eval_scripts/openpi/calvin_eval.py \
    --exp_name calvin_pi0 \
