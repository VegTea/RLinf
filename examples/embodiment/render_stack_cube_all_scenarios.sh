...
"${REPO_PATH}/.venv/bin/python" \
  ...
  --scenario-file "${REPO_PATH}/examples/embodiment/config/env/Isaaclab_table_cube_pose_test.jsonl" \
  "$@"

# --scenario-file "${REPO_PATH}/examples/embodiment/config/env/isaaclab_stack_cube.jsonl"
# --scenario-file "${REPO_PATH}/examples/embodiment/config/env/Isaaclab_table_test.jsonl"
