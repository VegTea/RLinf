...
TASK_NAME=insert_mouse_battery bash examples/recap/value/run_value_sft.sh yam_insert_mouse_battery_sft_value \
  +runner.resume_dir=/inspire/ssd/project/gjjproject/czxs24230043/RLinf/logs/value_sft/Phase2+insert_mouse_battery+20260706-02:06:32/yam_insert_mouse_battery_value_sft/checkpoints/global_step_4000 \
